...
// Material Symbols-style line icons, 24×24, used throughout the app.

export default function Icon({ name, size = 24, color = 'currentColor', stroke = 1.8 }) {
  const props = {
  ...
  switch (name) {
    ...
    case 'phone':
      return <svg {...props} fill={color} stroke="none"><path d="M19.23 15.26l-2.54-.29a1.5 1.5 0 0 0-1.27.43l-1.84 1.84a14 14 0 0 1-6.59-6.59l1.85-1.85a1.5 1.5 0 0 0 .43-1.27l-.29-2.52A1.5 1.5 0 0 0 7.49 4H5.03c-.84 0-1.55.7-1.5 1.55C3.97 13.62 10.4 20 18.46 20.47c.85.05 1.55-.66 1.55-1.51v-2.45a1.51 1.51 0 0 0-1.34-1.5z"/></svg>;
    case 'phone-end':
      return <svg {...props} fill={color} stroke="none"><path d="M12 9c-1.6 0-3.15.25-4.6.72v3.1c0 .39-.23.74-.56.9-.98.49-1.87 1.12-2.66 1.85-.18.18-.43.28-.7.28a1 1 0 0 1-.7-.29L.29 13.08a1 1 0 0 1-.29-.7c0-.28.11-.53.29-.71C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.67c.18.18.29.43.29.71a1 1 0 0 1-.29.7l-2.48 2.48a1 1 0 0 1-.7.29c-.27 0-.52-.1-.7-.28a11.65 11.65 0 0 0-2.67-1.85.99.99 0 0 1-.56-.89v-3.1A16.4 16.4 0 0 0 12 9z"/></svg>;
    case 'phone-incoming':
      return <svg {...props}><polyline points="16 2 16 8 22 8"/><line x1="22" y1="2" x2="16" y2="8"/><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.9.72 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0 1 22 16.92z"/></svg>;
    case 'phone-outgoing':
      return <svg {...props}><polyline points="22 8 22 2 16 2"/><line x1="16" y1="8" x2="22" y2="2"/><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.9.72 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0 1 22 16.92z"/></svg>;
    case 'phone-missed':
      return <svg {...props}><line x1="22" y1="2" x2="16" y2="8"/><line x1="16" y1="2" x2="22" y2="8"/><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.9.72 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0 1 22 16.92z"/></svg>;
    case 'people':
      return <svg {...props}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>;
    case 'person':
      return <svg {...props}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>;
    case 'ticket':
      return <svg {...props}><path d="M2 9V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4z"/><path d="M13 5v2M13 17v2M13 11v2"/></svg>;
    case 'add':
    ...
    case 'mic-off':
      return <svg {...props}><line x1="1" y1="1" x2="23" y2="23"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6"/><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23"/><line x1="12" y1="19" x2="12" y2="23"/></svg>;
    case 'speaker':
    ...
    case 'qr':
      return <svg {...props}><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3M21 14v0M14 21v-3M21 21v-7"/></svg>;
    case 'edit':
    ...
    case 'fingerprint':
      return <svg {...props}><path d="M12 11v3M12 17v.5M9.5 7.5a3 3 0 0 1 5 0c0 .5-.2 1-.5 1.4M7 9.5C7 6.5 9.2 4 12 4s5 2.5 5 5.5v2c0 2-1 4-2 5M5 13c0-1 .5-3 1-4M19 13c0-1-.5-3-1-4"/></svg>;
    default:
